...
```console
$ helm install stable/ibm-etcd-dev
```
...
```console
$ helm intall --name my-release stable/ibm-etcd-dev
```
...
The above parameters map to `ibm-etcd-dev` params.
...
```bash
$ helm install --name my-release -f values.yaml stable/ibm-etcd-dev
```
