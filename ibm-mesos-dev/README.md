...
```console
$ helm install stable/ibm-mesos-dev
```
...
```console
$ helm intall --name my-release stable/ibm-mesos-dev
```
...
The above parameters map to `ibm-mesos-dev` params.
...
```bash
$ helm install --name my-release -f values.yaml stable/ibm-mesos-dev
```
