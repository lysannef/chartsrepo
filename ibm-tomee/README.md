...
```console
$ helm intall --name my-release stable/ibm-tomee
```
...
The above parameters map to `ibm-tomee` params.
...
```bash
$ helm install --name my-release -f values.yaml stable/ibm-tomee
```
